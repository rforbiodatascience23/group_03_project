...
::: {.column width="50%"}
![](../results/project_flow_chart.png){.absolute top="50" left="600" width="450" height="650"}
:::
:::
...
![](../results/PCA_method.jpg){.absolute top="200" left="1" width="600" height="300"} ![](../results/Linear_model_method.png){.absolute top="200" left="700" width="400" height="350"}
