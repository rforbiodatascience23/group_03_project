...
dat_rep_meta_cols <- dat_rep_patient |>
  select(patient_n, gender, disease_state, date,geo_accession, identifier) |> 
  mutate(geo_accession = NA,
         identifier = NA) |> 
  distinct(patient_n, .keep_all = TRUE)
