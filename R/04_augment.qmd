...
non_normalized_expr <- dat_clean |> 
  ...
  labs(
    x = "Patient",
    y = "Non-normalized expression level (log2)",
    title = "Distribution of gene expression level for each patient without normalization",
    subtitle = "The most extreme values have been removed for illstrative puposes",
...
normalized_expr <- dat_aug |> 
  ...
  mutate(log2_norm_expression = log2(norm_expression)) |> 
  ggplot(mapping = aes(x = geo_accession,
  ...
  labs(
    ...
    title = "Distribution of gene expression level for each patient with normalization",
    subtitle = "The most extreme values have been removed for illstrative puposes",
    caption = "Data from Dawany et al. (2014)"
  ) 

ggsave("../results/normalized_expr.png", plot = non_normalized_expr)
